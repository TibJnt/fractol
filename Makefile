...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/07/25 17:33:56 by tjeunet           #+#    #+#              #
#    Updated: 2023/07/25 18:08:12 by tjeunet          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = parse_args.c colors.c events.c exit.c initialize.c main.c render.c utils.c\
